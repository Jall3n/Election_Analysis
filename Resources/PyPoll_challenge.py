...
file_to_load = '/Users/justinallen/Documents/UNC_Bootcamp/0-Modules/Module-3/Code/Resources/election_results.csv'
# Add a variable to save the file to a path.
#file_to_save = os.path.join("analysis", "election_analysis.txt")
file_to_save = '/Users/justinallen/Documents/UNC_Bootcamp/0-Modules/Module-3/Code/analysis/election_results.txt'
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (f"{county_name}: {votePercent:.1f}% ({voteCount:,})\n")
